...
@PostMapping("/addrdv/{serviceId}/{userId}")
@ResponseBody
public void addRdv(@RequestBody Appointment apt ,@PathVariable Long serviceId,@PathVariable  Long userId){
	appserv.addRdv(apt, serviceId, userId);
}
