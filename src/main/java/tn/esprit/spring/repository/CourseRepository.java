...
public interface CourseRepository extends JpaRepository<Course, Long> {
	...
	@Query(nativeQuery=true,value="SELECT certificate_id,course_id,user_user_id,start_date,domain FROM certificate c INNER JOIN course ON course.course_id=c.course_course_id WHERE user_user_id=:param")
	public List<String> getUserJoinedCourses(@Param("param")Long idUser);
}
/*
